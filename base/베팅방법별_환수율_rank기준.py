...
PROFILE_NAME = "균형주력_ROI보조_rank기준"
DEFAULT_FROM_DATE = "20260101"
DEFAULT_TO_DATE = "20261231"
DEFAULT_OUTPUT_PATH = "/Users/Super007/Documents/rank_total_new_균형주력_ROI보조_rank기준.csv"


def _run_calc_rank_anchor_26_trifecta_quietly(
    *,
    from_date,
    to_date,
    bet_unit=100,
    ...
    """rank 기준 계산은 콘솔 출력/CSV 저장/주간 upsert 없이 실행한다."""
    import contextlib
    import io
    from base import 총환수율_new_rank기준 as profit_base_mod
    ...
    try:
        ...
        with contextlib.redirect_stdout(io.StringIO()):
            return profit_base_mod.calc_rpop_anchor_26_trifecta(
                from_date=from_date,
                to_date=to_date,
                bet_unit=bet_unit,
...
def build_admin_profit_analysis_payload_for_range(from_date: str, to_date: str) -> dict:
    ...
    admin_profit_strategy_labels["top3pair_46_trifecta"] = "rank 1~3 복조 / 4~6 삼쌍"
    ...
    admin_profit_strategy_labels["top3_box_trifecta"] = "rank 1~3 삼쌍승식"
    ...
    admin_profit_strategy_labels["top4_box_trifecta"] = "rank 1~4 4복조 삼쌍"
    ...
    admin_profit_strategy_labels["anchor2_38_trifecta"] = "rank 2 축 rank 3~8 삼쌍"
    ...
    admin_profit_strategy_labels["anchor2_37_trifecta"] = "rank 2 축 rank 3~7 삼쌍"
    ...
    admin_profit_strategy_labels["anchor2_36_trifecta"] = "rank 2 축 rank 3~6 삼쌍"
    ...
    admin_profit_strategy_labels["anchor2_137_trifecta"] = "rank 2 축 rank 1,3~7 삼쌍"
    ...
    admin_profit_strategy_labels["anchor2_136_trifecta"] = "rank 2 축 rank 1,3~6 삼쌍"
    ...
    admin_profit_strategy_labels["anchor1_47_23"] = "rank 1 축 rank 4~7 / 2~3 삼쌍"
    ...
    admin_profit_strategy_labels["anchor1_27_trio"] = "rank 1 축 rank 2~7 삼복"
    ...
    admin_profit_strategy_labels["anchor1_26_trio"] = "rank 1 축 rank 2~6 삼복"
    ...
    admin_profit_strategy_labels["top4_box_trio"] = "rank 1~4 4복조 삼복"
    ...
    admin_profit_strategy_labels["top5_box_trifecta"] = "rank 1~5 5복조 삼쌍"
    ...
    admin_profit_strategy_labels["top5_box_trio"] = "rank 1~5 5복조 삼복"
    ...
    admin_profit_strategy_labels["top5pair_6_trio"] = "rank 1~5 복조 / 6 삼복"
    ...
    admin_profit_strategy_labels["top5pair_67_trio"] = "rank 1~5 복조 / 6~7 삼복"
    ...
    admin_profit_strategy_labels["top5pair_68_trio"] = "rank 1~5 복조 / 6~8 삼복"
    ...
    admin_profit_strategy_labels["top5pair_69_trio"] = "rank 1~5 복조 / 6~9 삼복"
    ...
    admin_profit_strategy_labels["top5pair_610_trio"] = "rank 1~5 복조 / 6~10 삼복"
    ...
    admin_profit_strategy_labels["top6_box_trifecta"] = "rank 1~6 6복조 삼쌍"
    ...
    admin_profit_strategy_labels["top6_box_trio"] = "rank 1~6 6복조 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_4_trio"] = "rank 1~2 복조 / 3~4 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_5_trio"] = "rank 1~2 복조 / 3~5 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_6_trio"] = "rank 1~2 복조 / 3~6 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_7_trio"] = "rank 1~2 복조 / 3~7 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_8_trio"] = "rank 1~2 복조 / 3~8 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_9_trio"] = "rank 1~2 복조 / 3~9 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_10_trio"] = "rank 1~2 복조 / 3~10 삼복"
    ...
    admin_profit_strategy_labels["top12anchor_3_12_trio"] = "rank 1,2 축 / 3~12 삼복"
    ...
    admin_profit_strategy_labels["anchor1_25_68"] = "rank 1 축 rank 2~5 / 6~8 삼쌍"
    ...
    admin_profit_strategy_labels["anchor1_25_69"] = "rank 1 축 rank 2~5 / 6~9 삼쌍"
    ...
    admin_profit_strategy_labels["anchor1_24_trio"] = "rank 1 축 rank 2~4 삼복"
    ...
    admin_profit_strategy_labels["anchor1_25_trio"] = "rank 1 축 rank 2~5 삼복"
    ...
    admin_profit_strategy_labels["top3pair_46_trio"] = "rank 1~3 복조 / 4~6 삼복"
    ...
    admin_profit_strategy_labels["top3pair_45_trio"] = "rank 1~3 복조 / 4~5 삼복"
    ...
    admin_profit_strategy_labels["top3pair_4_trio"] = "rank 1~3 복조 / 4 삼복"
    ...
    admin_profit_strategy_labels["top3pair_410_trio"] = "rank 1~3 복조 / 4~10 삼복"
    ...
    admin_profit_strategy_labels["top3pair_48_trio"] = "rank 1~3 복조 / 4~8 삼복"
    ...
    admin_profit_strategy_labels["top3pair_47_trio"] = "rank 1~3 복조 / 4~7 삼복"
    ...
    admin_profit_strategy_labels["top3pair_49_trio"] = "rank 1~3 복조 / 4~9 삼복"
    ...
    admin_profit_strategy_labels["pair24_top1_5_12_trio"] = (
        "rank 2~4 복조 / 1,5,6,7,8,9,10,11,12 삼복"
    )
    ...
    admin_profit_strategy_labels["pair24_top1_5_8_trio"] = "rank 2~4 복조 / 1, 5~8 삼복"
    ...
    admin_profit_strategy_labels["pair24_top1_5_7_trio"] = "rank 2~4 복조 / 1, 5~7 삼복"
    ...
    admin_profit_strategy_labels["pair24_top1_5_6_trio"] = "rank 2~4 복조 / 1, 5~6 삼복"
    ...
    admin_profit_strategy_labels["pair24_top1_5_trio"] = "rank 2~4 복조 / 1, 5 삼복"
    ...
    admin_profit_strategy_labels["pair24_top1_5_9_trio"] = "rank 2~4 복조 / 1, 5~9 삼복"
    ...
    admin_profit_strategy_labels["pair24_top1_5_10_trio"] = "rank 2~4 복조 / 1, 5~10 삼복"
    ...
    admin_profit_strategy_labels["pair25_top1_6_8_trio"] = "rank 2~5 복조 / 1,6,7,8 삼복"
    ...
    admin_profit_strategy_labels["pair25_top1_6_7_trio"] = "rank 2~5 복조 / 1,6,7 삼복"
    ...
    admin_profit_strategy_labels["pair25_top1_6_trio"] = "rank 2~5 복조 / 1,6 삼복"
    ...
    admin_profit_strategy_labels["anchor12_3_12_trifecta"] = "rank 1축 2축 / 3~12 삼쌍"
    ...
    admin_profit_strategy_labels["anchor21_3_12_trifecta"] = "rank 2를1축 1을2축 / 3~12 삼쌍"
    ...
    admin_profit_strategy_labels["anchor21_3_10_trifecta"] = "rank 2를1축 1을2축 / 3~10 삼쌍"
    ...
    admin_profit_strategy_labels["anchor12_3_10_trifecta"] = "rank 1축 2축 / 3~10 삼쌍"
    ...
    admin_profit_strategy_labels["anchor12_3_8_trifecta"] = "rank 1축 2축 / 3~8 삼쌍"
    ...
    admin_profit_strategy_labels["top4pair_56_trifecta"] = "rank 1~4 복조 / 5~6 삼쌍"
    ...
    admin_profit_strategy_labels["top4pair_57_trifecta"] = "rank 1~4 복조 / 5~7 삼쌍"
    ...
    admin_profit_strategy_labels["top4pair_57_trio"] = "rank 1~4 복조 / 5~7 삼복"
    ...
    admin_profit_strategy_labels["top4pair_56_trio"] = "rank 1~4 복조 / 5~6 삼복"
    ...
    admin_profit_strategy_labels["pair56_top4_trifecta"] = "rank 5~6 복조 / 1~4 삼쌍"
    ...
    admin_profit_strategy_labels["pair46_top3_trifecta"] = "rank 4~6 복조 / 1~3 삼쌍"
    ...
    admin_profit_strategy_labels["pair46_top3_trio"] = "rank 4~6 복조 / 1~3 삼복"
    ...
    admin_profit_strategy_labels["pair56_top4_trio"] = "rank 5~6 복조 / 1~4 삼복"
    ...
    try:
        race_df, _summary = _run_calc_rank_anchor_26_trifecta_quietly(
            from_date=from_date,
            to_date=to_date,
            bet_unit=100,
            apply_odds_filter=False,
