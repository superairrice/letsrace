...
def calc_top6_trifecta_raw(
    ...
    for (track, date, rno), g in df.groupby(["경마장", "경주일", "경주번호"]):
        ...
        refund_anchor_234 = odds * bet_unit if hit_anchor_234 == 1 else 0.0
        anchor_234_bet = 3 * bet_unit
        ...
        refund_anchor_25 = odds * bet_unit if hit_anchor_25 == 1 else 0.0
        anchor_25_bet = 6 * bet_unit
        ...
        refund_anchor_26 = odds * bet_unit if hit_anchor_26 == 1 else 0.0
        anchor_26_bet = 10 * bet_unit
        ...
        refund_anchor_27 = odds * bet_unit if hit_anchor_27 == 1 else 0.0
        anchor_27_bet = 15 * bet_unit
        ...
        race_rows.append(
            {
                ...
                "r_pop1_축_26_조합수": 10,
                "r_pop1_축_27_조합수": 15,
                "r_pop4_베팅금액": comb_by_n[4] * bet_unit,
                "r_pop5_베팅금액": comb_by_n[5] * bet_unit,
                "r_pop6_베팅금액": comb_by_n[6] * bet_unit,
                "r_pop1_축_234_베팅금액": 3 * bet_unit,
                "r_pop1_축_25_베팅금액": 6 * bet_unit,
                "r_pop1_축_26_베팅금액": 10 * bet_unit,
                "r_pop1_축_27_베팅금액": 15 * bet_unit,
                "구멍당_베팅금액": bet_unit,
                "삼복승식배당율": odds,
            }
        )
...
if __name__ == "__main__":
    ...
    out_path = "/Users/Super007/Documents/r_pop_reward_new.csv"
