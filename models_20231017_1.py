...
class PRecord(models.Model):
    rcity = models.CharField(max_length=4, db_collation='euckr_korean_ci')
    ...
    r1award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    r2award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    r3award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    r4award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    r5award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    sub1award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    sub2award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    sub3award = models.CharField(max_length=8, db_collation='euckr_korean_ci', blank=True, null=True)
    sale1 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sale2 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sale3 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sale4 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sale5 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sale6 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sale7 = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    sales = models.CharField(max_length=15, db_collation='euckr_korean_ci', blank=True, null=True)
    r1alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    r3alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    r2alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    r12alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    r23alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    r333alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    r123alloc = models.CharField(max_length=40, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_s1f = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_1c = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_2c = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_3c = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_4c = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_g1f = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    r3f = models.CharField(max_length=6, db_collation='euckr_korean_ci', blank=True, null=True)
    r4f = models.CharField(max_length=6, db_collation='euckr_korean_ci', blank=True, null=True)
    furlong = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
    passage_t = models.CharField(max_length=100, db_collation='euckr_korean_ci', blank=True, null=True)
...
class StartAudit(models.Model):
    ...
    gate = models.IntegerField()
    horse = models.CharField(max_length=18)
    rider = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    rider_k = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    audit_reason = models.CharField(max_length=20, db_collation='utf8mb3_general_ci', blank=True, null=True)
    judge = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    judge_reason = models.CharField(max_length=20, db_collation='utf8mb3_general_ci', blank=True, null=True)
...
class Train(models.Model):
    rcity = models.CharField(max_length=5, db_collation='utf8mb3_general_ci')
    tdate = models.CharField(primary_key=True, max_length=8, db_collation='utf8mb3_general_ci')
    horse = models.CharField(max_length=18, db_collation='utf8mb3_general_ci')
    team = models.CharField(max_length=3, db_collation='utf8mb3_general_ci', blank=True, null=True)
    team_num = models.CharField(max_length=3, db_collation='utf8mb3_general_ci', blank=True, null=True)
    grade = models.CharField(max_length=6, db_collation='utf8mb3_general_ci', blank=True, null=True)
    rider = models.CharField(max_length=12, db_collation='utf8mb3_general_ci')
    in_time = models.CharField(max_length=5, db_collation='utf8mb3_general_ci', blank=True, null=True)
    out_time = models.CharField(max_length=5, db_collation='utf8mb3_general_ci', blank=True, null=True)
    ...
    remark = models.CharField(max_length=4, db_collation='utf8mb3_general_ci', blank=True, null=True)
...
class Trainer(models.Model):
    rcity = models.CharField(primary_key=True, max_length=4)
    trainer = models.CharField(max_length=6, db_collation='utf8mb3_general_ci')
    birth = models.CharField(max_length=10, db_collation='utf8mb3_general_ci')
    team = models.CharField(max_length=3, db_collation='utf8mb3_general_ci', blank=True, null=True)
    age = models.CharField(max_length=2, db_collation='utf8mb3_general_ci', blank=True, null=True)
    debut = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    tot_race = models.IntegerField(blank=True, null=True)
    tot_1st = models.IntegerField(blank=True, null=True)
    tot_2nd = models.IntegerField(blank=True, null=True)
    tot_3rd = models.IntegerField(blank=True, null=True)
...
class Training(models.Model):
    ...
    horse = models.CharField(max_length=18)
    team = models.CharField(max_length=3, db_collation='utf8mb3_general_ci', blank=True, null=True)
    trainer = models.CharField(max_length=6, db_collation='utf8mb3_general_ci', blank=True, null=True)
    team_num = models.CharField(max_length=2, db_collation='utf8mb3_general_ci', blank=True, null=True)
    rider = models.CharField(max_length=2, db_collation='utf8mb3_general_ci', blank=True, null=True)
    in_time = models.CharField(max_length=5, db_collation='utf8mb3_general_ci', blank=True, null=True)
    out_time = models.CharField(max_length=5, db_collation='utf8mb3_general_ci', blank=True, null=True)
    t_time = models.CharField(max_length=5, db_collation='utf8mb3_general_ci', blank=True, null=True)
    remark = models.CharField(max_length=100, db_collation='utf8mb3_general_ci', blank=True, null=True)
...
class Treat(models.Model):
    ...
    tdate = models.CharField(max_length=10, db_collation='utf8mb3_general_ci')
    team = models.CharField(max_length=2, db_collation='utf8mb3_general_ci')
    hospital = models.CharField(max_length=30, db_collation='utf8mb3_general_ci')
...
class VarRace(models.Model):
    rcity = models.CharField(primary_key=True, max_length=4)
    distance = models.IntegerField()
    grade = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    weather = models.CharField(max_length=10, db_collation='utf8mb3_general_ci')
    rstate = models.CharField(max_length=10, db_collation='utf8mb3_general_ci')
    rmoisture = models.CharField(max_length=10, db_collation='utf8mb3_general_ci')
    gate = models.IntegerField()
    s1f = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    r1c = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    r2c = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    r3c = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    r4c = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    g3f = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    g2f = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    g1f = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    record = models.CharField(max_length=10, db_collation='utf8mb3_general_ci', blank=True, null=True)
    i_s1f = models.IntegerField(blank=True, null=True)
    i_r1c = models.IntegerField(blank=True, null=True)
    i_r2c = models.IntegerField(blank=True, null=True)
    i_r3c = models.IntegerField(blank=True, null=True)
