...
class Rec013(models.Model):
    ...
    target = models.CharField(max_length=6, blank=True, null=True)
    gate = models.IntegerField(blank=True, null=True)
    rname = models.CharField(max_length=20, blank=True, null=True)
    judge_type = models.CharField(max_length=20, blank=True, null=True)
    judge_con = models.CharField(max_length=60, blank=True, null=True)
    judge_detail = models.CharField(max_length=60, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'rec013'
        unique_together = (('rcity', 'rdate', 'rno', 'rno_seq'),)
